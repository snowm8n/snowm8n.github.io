document.addEventListener('DOMContentLoaded', () => {
            ...
            achievements: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            details: [
                                "Co-inventor on two confidential patents for a major interactive entertainment company.",
            ...
            <section class="section section-top">
                <div class="player-card p-8 flex flex-col">
                    ...
                    <div class="grid grid-cols-3 gap-4 pt-6 border-t border-slate-700">
                        <div class="text-center superpower-icon" data-task-id="gamification-icon" data-title="Gamification" data-tooltip="Designing engagement systems to exceed business goals and user expectations.">
        ...
        contact: `
            <section class="section section-top">
                <div class="max-w-xl mx-auto">
    				...
    				<a href="John-Sweeney-Resume.pdf" target="_blank" rel="noopener noreferrer" class="inline-block bg-slate-700 hover:bg-slate-600 text-white font-bold text-lg px-8 py-4 rounded-lg transition-transform duration-100 active:scale-95 w-full sm:w-auto">Resume</a>
                        </div>
                    </div>
                </div>
            </section>
    ...
    const renderView = (viewName) => {
        ...
        if (caseStudy.video) {
            mediaGalleryHTML = `<div id="media-gallery" class="mb-8">
                <a href="https://www.youtube.com/watch?v=${caseStudy.video}" target="_blank" class="video-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8"><path fill-rule="evenodd" d="M4.5 5.653c0-1.426 1.529-2.33 2.779-1.643l11.54 6.647c1.295.742 1.295 2.545 0 3.286L7.279 20.99c-1.25.722-2.779-.217-2.779-1.643V5.653z" clip-rule="evenodd" /></svg>
                    <span>Watch The Video</span>
                </a>
            </div>`;
        } else if (caseStudy.images && caseStudy.images.length > 0) {
            const slides = caseStudy.images.map(img => `<div class="carousel-slide"><img src="${img}" alt="${caseStudy.title} screenshot"></div>`).join('');
            mediaGalleryHTML = `<div id="media-gallery" class="mb-8">
        ...
        // --- ACTIVATE CAROUSEL ---
        const carouselContainer = caseStudyOverlay.querySelector('.carousel-container');
        if (carouselContainer) {
            const slides = carouselContainer.querySelectorAll('.carousel-slide');
            if (slides.length > 1) {
                let currentSlide = 0;
                slides[0].classList.add('active'); // Show the first slide immediately
                ...
                slides[0].classList.add('active'); // If there's only one image, just show it
            }
        }
