document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- DATA ---
    const profileImage = 'https://i.imgur.com/S7Kcw4g.jpeg';
    const achievements = [
        { icon: '🏆', text: '2x PlayStation Hackathon Winner' },
        { icon: '💡', text: 'Co-Inventor on 2 Confidential Patents' },
        { icon: '💰', text: '$8.23M Revenue Driven (Hogwarts Legacy)' },
        { icon: '🤝', text: 'Multi-Million Dollar Deal Secured' },
        { icon: '🚀', text: 'Saved an Entire Team from Layoffs' },
    ...
    const caseStudies = {
        's-tier-1': {
            tier: 's',
            title: 'GenAI Game Director For Hire',
            narrativeAngle: "When a critical leadership gap threatened to derail a multi-million dollar opportunity, I stepped beyond my Product Manager role to architect and build a high-fidelity, GenAI-powered game prototype. This hands-on approach secured the publishing deal in under 90 days.",
            strategicChallenge: "To secure a major publishing deal for a new GenAI interactive fiction title, the team needed a compelling creative vision and pitch materials. The project risked stalling due to the unavailability of the Game Director.",
            myRole: "As de facto Creative Director, I proactively took full ownership of the creative vision, defined core mechanics, and personally built the prototype that would greenlight the project and align all stakeholders.",
            execution: [
                "Developed the core pitch decks, established the visual identity, and defined the gameplay loop.",
                "Collaborated with engineering to design an AI-enhanced content pipeline and scoped an internal CMS.",
                "Personally built a high-fidelity video prototype using a full suite of GenAI tools: Midjourney, Kling, Runway, and ElevenLabs."
            ],
            innovations: {
                 title: "Key Innovations & Tools",
                 description: "The prototype was built using a full suite of modern GenAI tools to rapidly visualize the product and establish a scalable production pipeline.",
                 stack: [
                    { tool: "Midjourney", use: "Character creation and concept art." },
                    { tool: "Kling & Runway", use: "Character animation and lip-syncing." },
                    { tool: "ElevenLabs", use: "Converting my own VO into character voices." },
                    { tool: "Logic Pro X & Final Cut", use: "Final composition, UI, and sound." }
                ]
            },
            results: "The prototype I created was a key factor in securing a multi-million-dollar publishing deal, unifying stakeholders and establishing a new, scalable production pipeline for the studio."
        },
        's-tier-2': {
            tier: 's',
            title: 'Pitch to Profit: Saving The Dev Team',
            narrativeAngle: "With my team facing imminent layoffs after our platform was shut down, I conceived, pitched, and led the development of a new, sponsored PS4 application. By forging a partnership with Ad Sales and securing a $500k sponsorship, I turned a departmental crisis into a commercial success with a 100% profit margin, ensuring the future of every team member.",
            strategicChallenge: "Following the shutdown of PlayStation Home, my entire team faced layoffs due to their skills being tied to a legacy platform. The challenge was to create a new, commercially viable PS4 project that was profitable from day one.",
            myRole: "As Intrapreneur & Project Lead, I took end-to-end ownership of the business and product strategy, from identifying the market opportunity and securing executive buy-in to leading the cross-functional team through final delivery.",
            execution: [
                "Identified and pitched the concept of a sponsored E3 app, forging a key partnership with the Ad Sales team.",
                "Successfully secured a $500,000 sponsorship from Amazon Prime Video.",
                "Designed the entire gamified experience, including the quest loop and a high-value reward system to maximize user engagement.",
                "Acted as Producer for the marketing trailer, wrote all in-game copy, and secured the rights to use a beloved character (Toro) as the event's host."
            ],
            innovations: {
                title: "Key Features & Innovations",
                description: "The app was designed to be an immersive and rewarding experience for E3 attendees, both at home and on the show floor.",
                stack: [
                    { tool: "Immersive FTUE", use: "Personalized virtual E3 pass with the user's PSN Name." },
                    { tool: "Strategic IP Integration", use: "Secured rights to use Toro from Japan Studio as the event host." },
                    { tool: "High-Value Rewards", use: "Offered Sony Rewards points, Amazon Prime trials, and PS Now beta invites." }
                ]
            },
            results: "The project secured a $500k sponsorship and was delivered for under $250k (a 100% profit margin), which led to the entire team being saved from layoffs and formed into a new business unit."
        },
        's-tier-3': { 
            tier: 's', 
            title: 'Hogwarts Legacy: The Final Quest', 
            narrativeAngle: "Tasked with supporting a $36MM marketing campaign for a new IP, I designed and executed a three-month gamified experience that generated $8.23M in total game sales from over 182,000 participants. The campaign successfully educated a massive audience, built a vibrant community from scratch, and directly guided players into the purchase funnel.", 
            strategicChallenge: "The launch of a major new IP, Hogwarts Legacy, required a campaign that could educate a broad audience, build a dedicated community, and convert players. The core challenge was compounded by the fact that the underlying platform (XPPS) was scheduled to be sunset, meaning this project also had to prove the platform's immense and irreplaceable value to the business.", 
            myRole: "As Sr. Product Manager & Creative Strategy Lead, I owned the entire creative and product strategy for the quest, inventing new platform features and designing the full user journey to meet the campaign's complex business goals.", 
            execution: ["Invented and designed the 'Timed Reward' and 'Multiple Choice Task' systems.","Designed a bespoke leaderboard to track individual and House stats.","Developed a resourceful content strategy to repurpose old trailers.","Added a permanent 'Pre-order' link to the quest UI to reduce purchase friction."], 
            innovations: { 
                title: "Key Innovations & Data Capture", 
                description: "The campaign required new, bespoke features that not only drove engagement but also captured otherwise inaccessible data by linking activity directly to PSN IDs.", 
                stack: [{ tool: "'Choose Your House' Community Builder", use: "Gave players an immediate team and reason to care about the outcome." },{ tool: "Timed Reward System", use: "Kept the community engaged over a multi-week period with weekly challenges." },{ tool: "Bespoke Leaderboard", use: "Created layers of personal and communal motivation." }] 
            }, 
            results: "The campaign generated $8.23M in total sales (88.5% conversion). The massive engagement and sales data proved the platform's unique value, convincing leadership to postpone the shutdown to support future client campaigns." 
        },
    ...
    const quests = {
        's-tier-meta': { title: 'Top Tier Time', xp: 35, completed: false, required: ['s-tier-1', 's-tier-2', 's-tier-3'], objective: 'View all S-Tier projects to assess high-level strategic impact.' },
        'a-tier-meta': { title: 'Straight A\'s', xp: 25, completed: false, required: ['a-tier-1', 'a-tier-2'], objective: 'Explore A-Tier projects demonstrating vision and platform growth.' },
        ...
        'c-tier-1-quest': { title: 'Award Tour', xp: 10, completed: false, required: ['c-tier-1'], objective: 'Examine the awards and patents that drive my work.' },
        'player-card-quest': { title: 'Rare Player Card', xp: 5, completed: false, required: ['gamification-icon', 'genai-icon', 'storytelling-icon'], objective: 'Who Is This Guy?' },
        'contact-quest': { title: 'Let\'s Connect', xp: 10, completed: false, required: ['contact', 'linkedin'], objective: 'Make first contact to discuss future opportunities.' },
    };
    ...
    const renderView = (viewName) => {
        ...
        if (viewName === 'home' || viewName === 'contact') {
    ...
    const openCaseStudyModal = (taskId) => {
        ...
        if (caseStudy.tier === 'c') {
            ...
            contentHTML = `<nav id="project-nav-desktop" class="hidden md:block"><h3 class="font-bold text-white mb-4">Case Studies</h3><div class="flex flex-col gap-2">${projectPlaylist.map(id => `<a href="#" data-task-id="${id}" class="task-trigger project-nav-item ${id === taskId ? 'active' : ''} tier-${caseStudies[id].tier}">${caseStudies[id].title}</a>`).join('')}</div></nav>
                         <div class="modal-content tier-c"><div id="project-nav-mobile" class="md:hidden"><button data-task-id="${prevProjectId || ''}" class="task-trigger project-pager-btn tier-${prevProject?.tier}" ${!prevProjectId ? 'disabled' : ''}>&larr; Previous</button><button class="close-modal-btn"><svg class="w-8 h-8 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg></button><button data-task-id="${nextProjectId || ''}" class="task-trigger project-pager-btn tier-${nextProject?.tier}" ${!nextProjectId ? 'disabled' : ''}>Next &rarr;</button></div><div class="p-8 md:p-12"><h1 class="text-4xl sm:text-5xl font-extrabold tracking-tight text-white">${caseStudy.title}</h1><p class="mt-4 text-lg text-slate-400 max-w-2xl">${caseStudy.narrativeAngle}</p><div class="mt-12 space-y-8">${categoriesHTML}</div></div></div>`;
        ...
        caseStudyOverlay.querySelector('.modal-content').scrollTop = 0;
        completeTask(taskId);
    };
